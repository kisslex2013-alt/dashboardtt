...
import { Volume2, Play, Bell, Timer, CheckCircle, AlertCircle, XCircle, Zap } from 'lucide-react'
import { useSoundManager } from '../../../src/hooks/useSound'

/**
 * Концепт 2: Карточный grid
 * Стиль: сетка карточек 2x4, как календарь в PaymentDatesSettingsModal
 */
export function SoundAnimationConcept2({ isOpen, onClose }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {soundTypes.map((sound) => {
            ...
            return (
              <div
                key={sound.key}
                className="glass-effect rounded-xl p-4 border-l-4 hover:bg-white/20 dark:hover:bg-gray-800/70 hover:shadow-lg transition-all duration-300 flex flex-col"
