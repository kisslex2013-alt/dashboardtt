...
- Категорию/проект
- Почасовую ставку
- Описание`,icon:B},{heading:"Импорт и Экспорт",content:`• **Экспорт** — скачайте все данные в JSON-файл
• **Импорт** — загрузите данные из файла

Это позволяет переносить данные между устройствами и создавать резервные копии.`,icon:E}]},"basic-analytics":{title:"Базовая аналитика",sections:[{heading:"Что показывает",content:`Базовая аналитика — это ваш дашборд с ключевыми метриками:
