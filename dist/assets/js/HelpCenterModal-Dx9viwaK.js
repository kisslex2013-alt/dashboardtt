...
- Категорию/проект
- Почасовую ставку
- Описание`,icon:$},{heading:"Импорт и Экспорт",content:`• **Экспорт** — скачайте все данные в JSON-файл
...
• **Ctrl+Z** — Отменить
• **Ctrl+Y** — Повторить
• **Ctrl+Shift+E** — Экспорт данных`},{tip:"Все хоткейи можно посмотреть в Настройках → Горячие клавиши"}]},sync:{title:"Синхронизация и бэкапы",sections:[{heading:"Локальное хранение",content:"По умолчанию все данные хранятся локально в браузере (LocalStorage). Это безопасно, но данные привязаны к устройству.",icon:E},{heading:"Облачная синхронизация",content:`Зарегистрируйтесь, чтобы:
