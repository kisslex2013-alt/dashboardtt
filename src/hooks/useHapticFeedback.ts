 ...
 *
 * @returns Функция для запуска вибрации
 */
export function useHapticFeedback(): (pattern?: HapticPattern) => boolean {
  const trigger = useCallback((pattern: HapticPattern = 'light'): boolean => {
