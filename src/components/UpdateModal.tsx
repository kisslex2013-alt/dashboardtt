        ...
        {totalChanges > 0 && (
          <div className="mb-4 group overflow-hidden">
            <button
              ...
              className="w-full cursor-pointer text-sm font-semibold text-gray-900 dark:text-white mb-2 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center gap-1.5 select-none text-left"
            >
