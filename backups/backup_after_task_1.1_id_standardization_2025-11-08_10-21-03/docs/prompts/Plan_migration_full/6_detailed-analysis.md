...
*Что нужно для базовой работы таймера*
...
*Добавляем записи, категории, статистику*
...
*Модальные окна, графики, настройки*
...
```javascript
const [entries, setEntriesRaw, entriesSaveStatus] = useDebouncedLocalStorage('timeTrackerEntries', []);
```
