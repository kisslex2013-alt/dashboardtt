 ...
 */
export function AnimatedDate({ dateString, className = '', shouldAnimate = true, delay = 0 }) {
  ...
  // Создаем spring для каждой части (всегда вызываем хуки, даже если dateParts null)
  ...
  // Форматируем значения для отображения (всегда вызываем хуки)
