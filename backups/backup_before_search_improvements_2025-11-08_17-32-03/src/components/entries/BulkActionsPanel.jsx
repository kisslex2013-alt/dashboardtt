...
export function BulkActionsPanel({ 
  ...
  return (
    <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
      <div className={`flex ${isMobile ? 'flex-col' : 'items-center justify-between'} flex-wrap gap-3`}>
        {/* Информация о выборе */}
        <div className={`flex items-center ${isMobile ? 'justify-between w-full' : 'gap-3'} flex-wrap`}>
          <span className={`${isMobile ? 'text-base' : 'text-sm'} font-medium text-blue-800 dark:text-blue-200`}>
        ...
        <div className={`flex ${isMobile ? 'flex-col w-full gap-2' : 'items-center gap-2'} flex-wrap`}>
          <Button
