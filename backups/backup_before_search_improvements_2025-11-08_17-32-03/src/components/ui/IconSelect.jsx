...
import { Code, TrendingUp, Palette, Users, MessageCircle, BookOpen, MoreHorizontal, Grid, Activity, Calendar, Clock, DollarSign, Settings, Play, CheckCircle, Bell, Upload, Download, Database, Folder, FileText, X, Plus, Edit2, Trash2, Save, Eye, EyeOff, Filter, Search as SearchIcon } from 'lucide-react';
...
export function IconSelect({ 
  ...
  const iconOptions = useMemo(() => [
    ...
    { name: 'Search', component: SearchIcon, type: 'lucide', label: 'Search' },
          ...
          <div className="p-2">
            {iconsToShow.length === 0 && !isSearching ? (
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {(isPending || isSearching ? iconsToShow.slice(0, 50) : iconsToShow.slice(0, 100)).map((option) => {
...
const IconButton = memo(function IconButton({ option, isSelected, isIconify, color, onSelect }) {
  return (
    <button
      type="button"
...
IconButton.propTypes = {
  ...
  isIconify: PropTypes.bool.isRequired,
