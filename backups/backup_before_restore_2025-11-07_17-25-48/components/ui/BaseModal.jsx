...
export function BaseModal({
  ...
  return (
    ...
    >
      ...
      <DialogBackdrop
        transition
        className="fixed inset-0 bg-black/30 backdrop-blur-sm transition-opacity duration-[500ms] ease-out opacity-0 data-[enter]:opacity-100 data-[closed]:opacity-0"
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 overflow-y-auto pointer-events-none">
        ...
        <DialogPanel
          ...
          className={`
            ...
            data-[closed]:opacity-0 data-[closed]:scale-[0.95]
            ${sizeClasses[size]}
            ${className}
          `}
          style={{
