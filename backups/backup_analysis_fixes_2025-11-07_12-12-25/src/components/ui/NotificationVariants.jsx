 ...
 */
export function NotificationVariant1({ notification, onClose, progress }) {
    ...
    `}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className={`text-sm font-medium ${colors.textGlass}`}>
        ...
        <button 
          onClick={onClose} 
          className={`
            glass-button p-1 rounded-lg flex-shrink-0
  ...
  return (
    ...
    `}>
      <div className="flex items-center gap-2.5">
        ...
        <p className={`text-xs font-medium flex-1 ${colors.textGlass}`}>
          {notification.message}
        </p>
        <button 
          onClick={onClose} 
