...
export class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    logger.error('ErrorBoundary поймал ошибку:', error);
    logger.error('Информация об ошибке:', errorInfo);
    ...
    // Можно отправить ошибку в сервис мониторинга (например, Sentry)
    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
          <div className="glass-effect rounded-xl p-8 max-w-2xl w-full border-2 border-red-200 dark:border-red-800">
                  ...
                  <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 mb-4">
                    ...
                    {this.state.errorInfo?.componentStack && (
                      <details className="mt-2">
                        ...
                        <pre className="mt-2 text-xs text-red-800 dark:text-red-200 overflow-auto max-h-40">
                          {this.state.errorInfo.componentStack}
                        </pre>
                      </details>
                    )}
