          ...
          <div className="relative z-10">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-1">
                <button
                  ...
                  className="p-1.5 rounded-lg hover:bg-black/10 transition-colors text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-white"
            ...
            <div className="space-y-4">
              ...
              <div className="animate-slide-in" style={{ animationDelay: '0.15s' }}>
                ...
                <div className="w-full bg-gray-300 dark:bg-gray-700/50 rounded-full h-1 mt-1 overflow-hidden">
                  <div 
                    className="bg-purple-500 h-1 rounded-full transition-all duration-1000 ease-out"
                    style={{ 
        ...
        <div className="glass-card glow-orange relative bg-orange-200 dark:bg-yellow-500/10 border border-orange-300 dark:border-gray-700 rounded-2xl p-4 overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="space-y-6 flex flex-col justify-center h-full">
              {/* Год */}
              <div className="border-l-4 border-orange-400 pl-4 animate-slide-in opacity-0 animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
              ...
              {/* За все время */}
              <div className="border-l-4 border-red-400 pl-4 animate-slide-in opacity-0 animate-fade-in" style={{ animationDelay: '0.35s', animationFillMode: 'forwards' }}>
