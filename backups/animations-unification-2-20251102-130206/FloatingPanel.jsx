    ...
    >
      <div className="flex flex-col h-full gap-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={toggleSize}
            className="floating-panel-button p-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-shrink-0"
        ...
        <div className="flex items-center justify-between mt-auto gap-2">
          ...
          <button
            ...
            className="floating-panel-button px-2 py-1.5 rounded-lg bg-red-500 hover:bg-red-600 text-white transition-colors flex items-center gap-1.5 flex-1 min-w-0"
          ...
          <button
            onClick={toggleTheme}
            className="floating-panel-button p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex-shrink-0"
