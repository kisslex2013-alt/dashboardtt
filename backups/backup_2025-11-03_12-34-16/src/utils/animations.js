 ...
 */
export function getTransition(properties = ['all'], duration = ANIMATION_DURATIONS.NORMAL, easing = ANIMATION_EASING.STANDARD) {
  return properties
 ...
 */
export function getTransitionStyle(properties = ['transform', 'opacity'], speed = 'normal', easing = null) {
  const durations = {
    fast: ANIMATION_DURATIONS.FAST,
    normal: ANIMATION_DURATIONS.NORMAL,
    slow: ANIMATION_DURATIONS.SLOW,
...
/**
 * Экспорт всех констант и функций для удобного импорта
 */
export default {
  // Константы
  ANIMATION_DURATIONS,
  ...
  getHoverLiftClass,
  getHoverScaleClass,
  getActiveShrinkClass,
  getHoverCombinedClass,
  getButtonAnimationClasses,
  getCardAnimationClasses,
  getAppearAnimationClass,
  getDisappearAnimationClass,
  getIconRotateClass,
  getStaggeredDelayStyle,
};
