 ...
 */
export function GridView({ entries, onEdit, selectionMode = false, selectedEntries = new Set(), onToggleSelection }) {
  ...
  // Функция для получения категории (полного объекта) по ID
      ...
      {Object.entries(groupedEntries)
        ...
        .map(([date, dateEntries]) => {
          ...
          return (
            <div 
              key={date} 
              className="glass-effect rounded-2xl overflow-hidden hover:shadow-2xl hover:border-blue-300 dark:hover:border-blue-600 transition-normal shadow-xl snap-start hover-lift-scale"
            >
