...
import { Edit2, Trash2, Plus, Code, TrendingUp, Palette, Users, MessageCircle, BookOpen, MoreHorizontal, Grid, Activity, Calendar, Clock, DollarSign, Settings, Play, CheckCircle, Bell, Upload, Download, Database, Folder, FileText } from 'lucide-react';
      ...
      <div className="p-4 -mt-4">
                    ...
                    categories.map((category, index) => {
                      ...
                      return (
                        <tr
                          key={category.id}
                          className={`${
                            index < categories.length - 1 ? 'border-b border-gray-100 dark:border-gray-800' : ''
                        ...
                        >
                          ...
                          <td className="py-2 px-3 text-center">
                            <span className="text-xs text-gray-600 dark:text-gray-400">
                              {usageCount} {usageCount === 1 ? 'раз' : usageCount > 1 && usageCount < 5 ? 'раза' : 'раз'}
                            </span>
                          </td>
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              <p className="text-xs text-blue-800 dark:text-blue-300">
                💡 <strong>Подсказка:</strong> Категории используются для группировки записей времени. Нельзя удалить категорию, которая используется в записях.
              </p>
            </div>
      </div>
