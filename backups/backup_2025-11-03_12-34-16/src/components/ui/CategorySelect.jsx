  ...
  return (
    <>
      ...
      {shouldMount && createPortal(
        <div
          ref={dropdownRef}
          className={`fixed z-[999999] glass-effect rounded-lg border-2 border-gray-300 dark:border-gray-600 shadow-2xl max-h-64 overflow-y-auto bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg ${
