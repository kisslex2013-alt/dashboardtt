 ...
 */
export function CustomDatePicker({ value, onChange, onClose, placeholder = "дд/мм/гггг", inputRef }) {
        ...
        {allDays.map((date, index) => {
          ...
          return (
            <button
              ...
              className={`
                w-10 h-10 rounded-lg text-sm transition-normal hover-lift-scale
                ${!isCurrentMonth 
