 ...
 * 
 * Это хранилище управляет состоянием таймера реального времени.
 * Оно НЕ сохраняется в localStorage, так как таймер - это временное состояние.
 * 
 * Основные функции:
 * - Запуск таймера с выбором категории
 * - Отслеживание прошедшего времени
 * - Остановка таймера с возвратом времени
