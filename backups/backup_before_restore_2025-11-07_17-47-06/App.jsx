...
function App() {
  ...
  // ✅ ИСПРАВЛЕНО: HeadlessUI сам управляет жизненным циклом модальных окон через transition prop
  // useDelayedUnmount больше не нужен для модальных окон
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto p-6">
        ...
        {/* HeadlessUI сам управляет жизненным циклом через transition prop */}
