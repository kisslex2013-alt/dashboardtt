...
export const DEFAULT_ICON_REPLACEMENTS = {
  // Header buttons
 ...
 */
export const DEFAULT_BUTTON_COLOR_REPLACEMENTS = {
 ...
 * @returns {{ iconReplacements: Object, buttonColorReplacements: Object }}
 */
export function getDefaultIconSettings() {
  return {
