...
import { X, Smartphone } from '../../utils/icons'
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">200×100px</div>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">320×180px</div>
                    </div>
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Размытие</div>
                  </div>
                </button>
                <button
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Простая</div>
                  </div>
                </button>
              </div>
            </div>
