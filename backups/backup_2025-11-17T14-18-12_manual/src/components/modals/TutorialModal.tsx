      ...
      content: (
        <div className="space-y-3">
          <p className="text-gray-700 dark:text-gray-300">
            <strong>Time Tracker Dashboard v1.2.4</strong> - это современное приложение для учета
      ...
      content: (
        <div className="space-y-3">
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg mt-4">
            <h5 className="font-semibold text-sm mb-2">✨ Новые функции v1.2.4:</h5>
            <ul className="text-sm space-y-1 text-gray-700 dark:text-gray-300">
              <li>✓ <strong>Быстрый старт таймера</strong> - кнопка в шапке для мгновенного запуска</li>
              <li>✓ <strong>Индикаторы продуктивности</strong> - визуальный прогресс по целям, регулярности, фокусу и перерывам</li>
              <li>✓ <strong>Иллюстрации для пустых графиков</strong> - красивые анимированные картинки вместо пустых экранов</li>
              <li>✓ <strong>Информационные подсказки</strong> - тултипы с описанием каждого графика</li>
            </ul>
          </div>
        </div>
      ),
