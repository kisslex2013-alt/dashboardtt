          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="glass-effect px-2.5 py-1.5 pr-8 rounded-lg border border-gray-300 dark:border-gray-600 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer font-medium text-left transition-normal hover-lift-scale click-shrink min-w-[100px]"
              >
                {currentLabel}
                <ChevronDown
