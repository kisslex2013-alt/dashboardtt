...
import { BarChart2 } from '../../utils/icons'
import { ChartTypeSwitcher } from '../ui/ChartTypeSwitcher'
import { useTheme, useCategories } from '../../store/useSettingsStore'
...
export function CategoryEfficiencyChart({ entries }) {
  ...
  const chartData = useMemo(() => {
    ...
    return Object.values(categoryStats).sort((a, b) => b.earned - a.earned)
  }, [entries, categories])
