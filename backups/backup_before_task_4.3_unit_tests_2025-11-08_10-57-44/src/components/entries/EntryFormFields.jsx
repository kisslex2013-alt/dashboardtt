    ...
    <div className="space-y-4">
      ...
      {!effectiveEntry?.id && (
        <div>
          ...
          {errors.date && (
            <p id="date-error" className="text-red-500 text-sm mt-1" role="alert" aria-live="polite">{errors.date}</p>
          )}
        </div>
      )}
      ...
      <div>
        ...
        />
        {errors.category && (
          <p id="category-select-error" className="text-red-500 text-sm mt-1" role="alert" aria-live="polite">{errors.category}</p>
        )}
      </div>
