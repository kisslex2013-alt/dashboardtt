...
import { Undo, Redo, List, Grid, Clock, Plus, Play, Square, Download, Upload, Folder, HardDrive, CheckSquare, X, Search } from 'lucide-react';
      ...
      >
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pl-10 glass-effect rounded-lg border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
            autoFocus
            style={{
