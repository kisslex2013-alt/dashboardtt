...
export const AnalyticsSection = memo(function AnalyticsSection() {
  ...
  const toggleChartVisibility = useCallback((chartKey) => {
    updateChartVisibility({
      ...
      <div className={`glass-effect rounded-xl p-4 mb-4 overflow-visible ${isExpanded ? 'sticky top-0 z-40 backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 shadow-lg transition-normal' : ''}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 id="analytics-section-header" className="text-xl font-bold">Графики</h2>
          </div>
            ...
            <div className={`flex items-center ${isMobile ? 'gap-1' : 'gap-2'}`}>
              ...
              <div className="relative">
                <button
                  ...
                  className={`glass-effect ${isMobile ? 'px-2 py-1 pr-6 text-xs min-w-[80px]' : 'px-4 py-2 pr-10 text-sm min-w-[180px]'} rounded-lg border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer font-medium text-left transition-normal hover-lift-scale click-shrink touch-manipulation`}
