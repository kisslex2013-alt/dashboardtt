  ...
  ({
    ...
    return (
      <div
        ...
        className={`dashboard-card p-3 sm:p-4 border-2 rounded-xl bg-white dark:bg-gray-800 cursor-pointer transition-all duration-200 ${
          isSelected
            ...
            return (
              <button
                ...
                className={`day-dot w-4 h-4 sm:w-5 sm:h-5 text-[9px] sm:text-[10px] flex items-center justify-center ${
                  ...
                  template.id === 'custom'
                    ? 'cursor-pointer hover-lift-scale click-shrink'
                    : 'cursor-pointer' // Кликабельно, но клик идет на родителя
                } transition-normal`}
              >
                {calendarItem.day}
              </button>
