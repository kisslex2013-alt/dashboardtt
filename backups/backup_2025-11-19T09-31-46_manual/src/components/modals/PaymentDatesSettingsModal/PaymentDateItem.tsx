  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1 flex items-center gap-1 drop-shadow-sm whitespace-nowrap">
        ...
        <div className="flex items-center gap-2">
          ...
          {payment.enabled ? (
            <span className="text-xs bg-green-500/15 dark:bg-green-500/20 text-green-600 dark:text-green-400 px-2 py-0.5 rounded flex items-center gap-1 drop-shadow-sm whitespace-nowrap">
              <Repeat className="w-3 h-3" />
              Повторяется
            </span>
          ) : (
            <span className="text-xs bg-orange-500/15 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400 px-2 py-0.5 rounded flex items-center gap-1 drop-shadow-sm whitespace-nowrap">
