      ...
      content: (
        <div className="space-y-3">
          <p className="text-gray-700 dark:text-gray-300">
            <strong>Time Tracker Dashboard v1.2.3</strong> - это современное приложение для учета
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg mt-3">
            <h5 className="font-semibold text-xs mb-1">✨ Новые функции v1.2.3:</h5>
            <ul className="text-xs space-y-0.5 text-gray-600 dark:text-gray-400">
              ...
              <li>✓ Иллюстрации для пустых графиков - красивые анимированные картинки вместо пустых экранов</li>
              <li>✓ Информационные подсказки - тултипы с описанием каждого графика</li>
            </ul>
          </div>
        </div>
      ),
