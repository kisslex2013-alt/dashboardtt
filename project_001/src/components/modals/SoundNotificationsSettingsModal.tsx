                    ...
                    <div className="flex gap-2 flex-1">
                      <div className="flex-1 relative">
                        <select
                          ...
                          className="w-full px-3 py-2 bg-gray-800 dark:bg-gray-700 border border-gray-700 dark:border-gray-600 rounded-lg text-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none"
                          style={{
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div
                            ...
                            className="ml-2 p-1 rounded hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors flex-shrink-0"
