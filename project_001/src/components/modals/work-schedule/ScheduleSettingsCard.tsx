      ...
      >
        ...
        >
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-1.5 sm:p-2 animate-slide-up">
            <div className="text-[9px] font-medium text-blue-600 dark:text-blue-400 mb-0.5 whitespace-nowrap">
              ВЫБРАНО
            </div>
            <div className="text-sm sm:text-base font-bold text-blue-900 dark:text-blue-100 whitespace-nowrap">
              {selectedTemplate}
            </div>
            <div className="text-[9px] text-blue-600 dark:text-blue-400 truncate whitespace-nowrap">
          ...
          >
            <div className="text-[9px] font-medium text-green-600 dark:text-green-400 mb-0.5 whitespace-nowrap">
              РАБОЧИХ
            </div>
            <div className="text-sm sm:text-base font-bold text-green-900 dark:text-green-100 whitespace-nowrap">
              {selectedSchedule.monthlyDays}
            </div>
            <div className="text-[9px] text-green-600 dark:text-green-400 whitespace-nowrap">дней</div>
          </div>
          <div
          ...
          >
            <div className="text-[9px] font-medium text-purple-600 dark:text-purple-400 mb-0.5 whitespace-nowrap">
              ПЛАН/ДЕНЬ
            </div>
            <div className="text-sm sm:text-base font-bold text-purple-900 dark:text-purple-100 whitespace-nowrap">
              {(dailyPlan / 1000).toFixed(0)}K ₽
            </div>
            <div className="text-[9px] text-purple-600 dark:text-purple-400 whitespace-nowrap">цель</div>
          </div>
          <div
          ...
          >
            ...
            <div className="text-[9px] text-blue-600 dark:text-blue-400 whitespace-nowrap">авто</div>
          </div>
        </div>
        ...
        >
          <div className={selectedTemplate === 'custom' ? 'flex-1' : ''}>
            <label className="block text-[9px] sm:text-[10px] font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:mb-1.5 uppercase tracking-wide whitespace-nowrap">
              Дневной план
            </label>
