import { Calendar, Save, Trash2, X, Palette, Repeat, CalendarX } from '../../../utils/icons'
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div>
          ...
          <input
            ...
            className="w-full h-7 bg-white dark:bg-gray-700 rounded border border-gray-300 dark:border-gray-600"
          />
        </div>
      </div>
