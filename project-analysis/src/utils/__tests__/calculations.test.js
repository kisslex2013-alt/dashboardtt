...
describe('calculations', () => {
  ...
  describe('calculateStats', () => {
    it('should calculate statistics for entries in date range', () => {
      ...
      expect(parseFloat(stats.totalHours)).toBeGreaterThanOrEqual(6)
      expect(parseFloat(stats.totalEarned)).toBeGreaterThanOrEqual(6000)
  ...
  describe('calculateTrend', () => {
    ...
    it('should handle zero previous value', () => {
      ...
      expect(parseFloat(result.change)).toBe(100)
      expect(parseFloat(result.percentage)).toBe(100)
      expect(result.direction).toBe('up')
    })
  })
