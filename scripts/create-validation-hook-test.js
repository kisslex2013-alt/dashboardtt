...
const testFile = path.join(process.cwd(), 'src/hooks/__tests__/useEntryValidation.test.js')
...
describe('useEntryValidation', () => {
  ...
  it('should initialize with empty errors', () => {
    ...
    const { result } = renderHook(() => 
      useEntryValidation(formData, mockEntries, null)
    );
  ...
  it('should exclude current entry from overlap check', () => {
    ...
    const { result } = renderHook(() => 
      useEntryValidation(formData, mockEntries, effectiveEntry)
    );
...
console.log('✅ Тесты для useEntryValidation.js созданы')
